...
public class RunWarning extends Application {
	...
	public void SetAnchor(){
		try{
			...
			loader.setLocation(RunWarning.class.getResource("WarningAnchor.fxml"));
			AnchorPane WarningAnchor=(AnchorPane)loader.load();
			border.setCenter(WarningAnchor);
			
			//set controller
			WarningAnchorController controller=loader.getController();
	...
	public void SetBorder(){
		try {
            ...
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(RunWarning.class.getResource("WarningBorder.fxml"));
